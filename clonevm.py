...
def start(template_str):
    ...
    vmname = template_str + ''.join(random.SystemRandom().choice(string.ascii_uppercase + string.digits) for _ in range(8))
    dc_name, vm_folder, ds_name, cluster_name, resource_pool, ds_cluster_name = (None for i in range(6))
    power_on = True
    ...
    if template:
        clone_vm(
            ...
            resource_pool, power_on, ds_cluster_name)
    else:

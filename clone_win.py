...
def clone_vm(content, template, vm_name, datacenter_name, vm_folder, datastore_name,
    ...
    for i in range(nicnum):
        ...
        try:
            guest_map.adapter.gateway = '10.220.29.1'
        except:
            pass
    ...
    if 'windows' not in guestid:
        ...
        ident.domain = 'logistics.intra'
        ident.hostName = vim.vm.customization.FixedName()
        ident.hostName.name = vm_name #*** kw0tevmwos  ***
        print "hay hay"
    else:
        ...
        ident.guiUnattended.password.value = 'S!kButN0ll'
...
#start(vmname, template_str, cpus, mem, "Cloned", 1, nics)